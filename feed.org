...
#+include: articles/2020/musical-goals.org :lines "2-"
* Dark Mode                                                           :Hacks:
:PROPERTIES:
...
#+include: articles/2020/dark-mode.org :lines "2-"
...
#+include: articles/2020/driving-technical-change.org :lines "2-"
...
* Speeding up tests on CircleCI for a Python Django project :Python:CircleCI:
  ...
  #+include: articles/2019/speed-up-circleci.org :lines "2-"
...
* Digital Minimalism                                      :Lifestyle:Reviews:
  ...
  #+include: articles/2019/digital-minimalism.org :lines "2-"
...
* Learning Guitar Update                                              :Music:
  ...
  #+include: articles/2019/learning-guitar-update.org :lines "2-"
...
* Bose QuietComfort 35 Review                                       :Reviews:
  ...
  #+include: articles/2019/bose-quietcomfort-35-review.org :lines "2-"
* Musical Goals January Update                                        :Music:
  ...
  #+include: articles/2019/musical-goals-january-update.org :lines "2-"
* My Musical Goals for 2019                                           :Music:
  ...
  #+include: articles/2019/musical-goals-for-2019.org :lines "2-"
...
* Extracting Minecraft Music with Python                   :Minecraft:Python:
  ...
  #+include: articles/2018/minecraft-music-extractor.org :lines "2-"
