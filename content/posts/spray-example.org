...
- The [[http://spray.io/documentation/1.2.0/spray-routing/future-%20directives/onSuccess/][onSuccess]] directive, which allows us to improve on my [[file:file:spray-routing-error-handling.org][previous]]
