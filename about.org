...
working remotely from the North East of England.
I've previously worked in London and Hong Kong.
Employers have paid me to write HTML, PHP, Perl, C, JavaScript, Java, Objective-C, Scala,
Python, Bash and English.

I'm from Hovdebygda, in [[https://en.wikipedia.org/wiki/%C3%98rsta][Ørsta]],
on the west coast of Norway.
I studied electronics,
and endured compulsory military service as a
