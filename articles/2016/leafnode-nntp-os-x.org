...
#+date: <2016-05-12>
#+index: Leafnode!Setting up on OS X
#+begin_abstract
...
[[http://leafnode.sourceforge.net][Leafnode]] NNTP server locally. As a
...
you can view in listing [[lst:leafnode.cfg]]. (You obviously have to change
=hostname= to suit you.)
